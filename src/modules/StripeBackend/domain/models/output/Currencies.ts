...
export const Currencies = {
  ...
  XCD: {
    ...
    rounding: 0,
    code: "XCD",
    namePlural: "East Carribean dollars",
  },
  XDR: {
    symbol: "",
    name: "",
...
} as { [key: string]: CurrencyConfig };

export type Currency = (typeof Currencies)[string];
